...
correct1
precision1 <- (tr1[1,1])/(tr1[1,1]+tr1[1,2])
precision1 <- precision1 * 100
precision1
recall1 <- (tr1[1,1])/(tr1[1,1]+tr1[2,1])
recall1 <- recall1 * 100
recall1
...
correct2
precision2 <- (tr2[1,1])/(tr2[1,1]+tr2[1,2])
precision2 <- precision2 * 100
precision2
recall2 <- (tr2[1,1])/(tr2[1,1]+tr2[2,1])
recall2 <- recall2 * 100
recall2
...
correct4
precision4 <- (tr4[1,1])/(tr4[1,1]+tr4[1,2])
precision4 <- precision4 * 100
precision4
recall4 <- (tr4[1,1])/(tr4[1,1]+tr4[2,1])
recall4 <- recall4 * 100
recall4
...
correct8
precision8 <- (tr8[1,1])/(tr8[1,1]+tr8[1,2])
precision8 <- precision8 * 100
precision8
recall8 <- (tr8[1,1])/(tr8[1,1]+tr8[2,1])
recall8 <- recall8 * 100
recall8  
...
correct9
precision9 <- (tr9[1,1])/(tr9[1,1]+tr9[1,2])
precision9 <- precision9 * 100
precision9
recall9 <- (tr9[1,1])/(tr9[1,1]+tr9[2,1])
recall9 <- recall9 * 100
recall9  
# To show variable importance plot , i.e which variable is much important , we use the following command-
...
correct11
precision11 <- (tr11[1,1])/(tr11[1,1]+tr11[1,2])
precision11 <- precision11 * 100
precision11
recall11 <- (tr11[1,1])/(tr11[1,1]+tr11[2,1])
recall11 <- recall11 * 100
recall11
...
correct12
precision12 <- (tr12[1,1])/(tr12[1,1]+tr12[1,2])
precision12<- precision12 * 100
precision12
recall12 <- (tr12[1,1])/(tr12[1,1]+tr12[2,1])
recall12 <- recall12 * 100
recall12
...
correct13
precision13 <- (tr13[1,1])/(tr13[1,1]+tr13[1,2])
precision13 <- precision13 * 100
precision13
recall13 <- (tr13[1,1])/(tr13[1,1]+tr13[2,1])
recall13 <- recall13 * 100
recall13
...
correct15
precision15 <- (tr15[1,1])/(tr15[1,1]+tr15[1,2])
precision15 <- precision15 * 100
precision15
recall15 <- (tr15[1,1])/(tr15[1,1]+tr15[2,1])
recall15 <- recall15 * 100
recall15
